  ...
  return (
    <div className="mob:mb-8 md:mb-0">
        ...
        <div className="hidden md:block md:col-span-1 h-[80vh] relative">
            <div className="about-section overflow-y-scroll h-full no-scrollbar pr-4">
            {/* The mask should overlay this container at the bottom */}
            <div className="about-wrapper">
                <div className="about-header transition-opacity duration-100">
                    ...
                    <p className="font-jura font-light text-[#FFFBF8] text-[1vw] mb-[1em]">
                        Full breakdown of tools and experience? <a href="https://drive.google.com/file/d/1HIt5OOZioMAZT7CY-y3djO8mAZhHhEMT/view?usp=sharing" target="_blank" className="text-[#bf5fff] hover:text-[#09FFD8] transition-colors duration-200">Check my CV</a>.
                    </p>
